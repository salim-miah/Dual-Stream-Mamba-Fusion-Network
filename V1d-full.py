...
class Config:
    def __init__(self):
        ...
        self.model_save_dir = "/home/affshafee/T2430421/pipelines/V1d on AVLips/"
...
def main():
    ...
    model_path = os.path.join(config.model_save_dir, 'v1d_best.pth')
    ...
    plt.tight_layout()
    plt.savefig('/home/affshafee/T2430421/pipelines/V1d on AVLips/v1d_loss_curve.png', dpi=150, bbox_inches='tight')
    plt.show()

    print("\n✅ V1d training completed!")
    print("📝 Record these metrics for future comparison:")
    print(f"   - Variant: V1")
