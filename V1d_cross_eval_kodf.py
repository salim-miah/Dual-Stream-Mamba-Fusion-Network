...
"""
CROSS-DATASET EVALUATION: V1d (AVLips) → KoDF
This script evaluates a model trained on AVLips against the KoDF dataset.
"""
...
class Config:
    def __init__(self):
        ...
        self.model_path = "/home/affshafee/T2430421/pipelines/V1d on AVLips/V1d_best.pth"
        self.output_dir = "/home/affshafee/T2430421/pipelines/V1d_AVL_to_KoDF"
        ...
        # --- Sampling Strategy ---
        # For 600GB dataset, we'll use stratified sampling
...
# --- 5. MODEL ARCHITECTURE (SAME AS TRAINING) ---
...
def plot_confusion_matrix(cm, output_path):
    ...
    plt.title('Confusion Matrix: V1d (AVLips) → KoDF')
...
def main():
    print("\n" + "="*80)
    print("CROSS-DATASET EVALUATION: V1d (AVLips) → KoDF")
    print("="*80)
    ...
    cm_path = os.path.join(config.output_dir, 'confusion_matrix_kodf.png')
    ...
    with open(results_path, 'w') as f:
        f.write("="*80 + "\n")
        f.write("CROSS-DATASET EVALUATION: V1d (AVLips) → KoDF\n")
        f.write("="*80 + "\n\n")
